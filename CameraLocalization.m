...
for i=2:length(Start_End_PoseID)
    ...
    [Robot_Pose_Adjusted(:,:,i), cumulative_error(:,i)]=ICP(Robot_Pose_Guess(:,:,i),Landmarks_InWorld(:,2:end)',BackProjectedLandmarks(:,2:end)', 3, 0.001, 10e-6, H_odom(4:6,4:6));
...
% [Camera_Pose_Adjusted(:,:,i), cumulative_error(:,i)]=ICP(Camera_Pose_Guess(:,:,i), Landmarks, Image_Landmarks, 5, 0.01, 10e-9, H_odom, CameraCalibration);
%
